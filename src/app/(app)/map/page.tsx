            ...
            <AnimatePresence>
              {selectedBar && (
                <motion.div
                  ...
                  className={`absolute bottom-0 left-0 right-0 z-30 bg-glupp-bg border-t border-glupp-border rounded-t-2xl shadow-xl ${
                    sheetExpanded ? "max-h-[75vh]" : "max-h-[35vh]"
